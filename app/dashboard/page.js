  ...
  return (
    <div style={{ position: "relative", width: 140, height: 140 }}>
      ...
      <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", color: "#fff" }}>
        ...
        <div style={{ fontSize: 11, opacity: 0.85, marginTop: 4 }}>of {Number(target).toFixed(1)} goal</div>
      </div>
    </div>
  );
}
      ...
      <div style={{ padding: "24px 26px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
        ...
        {hasModules ? (
              ...
              return (
                <div key={mod}>
                  <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 5 }}>
                    <span style={{ fontSize: 13, color: "#334155", textTransform: "capitalize", fontWeight: 500 }}>{mod}</span>
          ...
          <div style={{ color: "#64748b", fontSize: 13.5, lineHeight: 1.6 }}>
            Complete a test to see your per-module band breakdown here. Start with a free diagnostic to
