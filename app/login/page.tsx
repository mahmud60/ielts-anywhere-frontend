    ...
    <div style={s.wrap}>
      <div style={s.card}>
        ...
        {!isFirebaseConfigured && (
          <p style={{ ...s.err, marginBottom: 16 }}>
            Firebase env vars are missing. Copy <code style={{ fontSize: 12 }}>.env.example</code> to{" "}
            <code style={{ fontSize: 12 }}>.env.local</code> and set{" "}
            <code style={{ fontSize: 12 }}>NEXT_PUBLIC_FIREBASE_*</code>.
          </p>
        )}

        {/* Google button */}
        <button style={s.googleBtn} onClick={signInWithGoogle} disabled={loading || !isFirebaseConfigured}>
        ...
        <form onSubmit={submit}>
          ...
          <button style={s.btn} disabled={loading || !isFirebaseConfigured}>
