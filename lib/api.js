...
const BASE =
  typeof window !== "undefined" ? "/api-backend" : REMOTE_BASE;
...
export const api = {
  ...
  getSpeakingSessionToken: () => apiFetch("/speaking/session-token"),
  elSubmitSpeaking: (sessionId, transcript, elSessionId) =>
