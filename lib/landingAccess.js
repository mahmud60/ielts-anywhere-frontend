...
/**
 * Master switch for the in-app "Upgrade to Pro" CTAs. Temporarily OFF while
 * there's no payment provider wired up (LemonSqueezy was removed pending a
 * replacement), so users aren't prompted toward a dead checkout. Flip to true
 * to bring every in-app upgrade prompt back in one place.
 *
 * Pro gating itself is unaffected — free users are still gated out of Pro
 * features; they just don't see an upgrade prompt.
 */
export const PRO_UPGRADE_ENABLED = false;
